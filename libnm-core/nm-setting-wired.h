 ...
 * @NM_SETTING_WIRED_WAKE_ON_LAN_NONE: No Wake-on-LAN option selected
 ...
 * @NM_SETTING_WIRED_WAKE_ON_LAN_ALL: Combination of all non-default flags
 *
...
typedef enum {
	...
	NM_SETTING_WIRED_WAKE_ON_LAN_ALL       = (1 << 7) - 1 - (1 << 0),
} NMSettingWiredWakeOnLan;
