...
NM_AVAILABLE_IN_1_2
const char *nm_vpn_plugin_info_get_default_dir_etc (void);
NM_AVAILABLE_IN_1_2
const char *nm_vpn_plugin_info_get_default_dir_lib (void);
NM_AVAILABLE_IN_1_2
const char *nm_vpn_plugin_info_get_default_dir_user (void);
NM_AVAILABLE_IN_1_2
GSList *nm_vpn_plugin_info_load_dir (void);
NM_AVAILABLE_IN_1_2
GSList *nm_vpn_plugin_info_load_dir_full (const char *dirname,
                                          gboolean do_validate_filename,
                                          int check_owner,
                                          NMUtilsCheckFilePredicate check_file,
                                          gpointer user_data);
