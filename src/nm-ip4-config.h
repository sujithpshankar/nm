...
#define NM_IP4_CONFIG_OPTIONS "options"
...
/* DNS options */
void nm_ip4_config_reset_options (NMIP4Config *config);
void nm_ip4_config_add_option (NMIP4Config *config, const char *option);
void nm_ip4_config_del_option (NMIP4Config *config, guint i);
guint32 nm_ip4_config_get_num_options (const NMIP4Config *config);
const char * nm_ip4_config_get_option (const NMIP4Config *config, guint i);
