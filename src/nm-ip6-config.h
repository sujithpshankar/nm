...
#define NM_IP6_CONFIG_OPTIONS "options"
...
/* DNS options */
void nm_ip6_config_reset_options (NMIP6Config *config);
void nm_ip6_config_add_option (NMIP6Config *config, const char *option);
void nm_ip6_config_del_option (NMIP6Config *config, guint i);
guint32 nm_ip6_config_get_num_options (const NMIP6Config *config);
const char * nm_ip6_config_get_option (const NMIP6Config *config, guint i);
