...
#define HOSTNAME_FILE_ARCH      "/etc/conf.d/hostname"
...
#elif defined(HOSTNAME_PERSIST_ARCH)
#define HOSTNAME_FILE           HOSTNAME_FILE_ARCH
#else
...
static gchar *
read_hostname_arch (const char *path)
{
